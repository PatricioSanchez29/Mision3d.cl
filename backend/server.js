...
async function startServer() {
  ...
  // ====== INICIO: Definición de rutas y arranque del servidor ======
  ...
  app.post("/api/payments/flow", paymentLimiter, async (req, res) => {
    // ...existing code del endpoint Flow...
    // Copiar el código del endpoint Flow aquí
    // ...
    // (El código completo ya está en el archivo, solo muévelo aquí)
  });

  // ===== Endpoint Webpay Plus =====
  app.post('/api/payments/webpay', paymentLimiter, async (req, res) => {
    // ...existing code del endpoint Webpay Plus...
    // Copiar el código del endpoint Webpay aquí
    // ...
  });

  // Retorno Webpay (commit)
  app.get('/webpay/retorno', async (req, res) => {
    // ...existing code del endpoint retorno Webpay...
  });

  // ===== Endpoint Khipu =====
  app.post('/api/payments/khipu', paymentLimiter, async (req, res) => {
    // ...existing code del endpoint Khipu...
  });
  ...
  // ====== FIN: Definición de rutas y arranque del servidor ======
}
