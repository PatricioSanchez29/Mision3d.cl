...
(function(){
  ...
  function injectStyles(){
    ...
    var css = '\n#cookie-banner{box-sizing:border-box;position:fixed;left:16px;right:16px;bottom:16px;background:#0f172a;color:#e2e8f0;border:1px solid #334155;border-radius:12px;padding:14px 16px;display:flex;gap:14px;align-items:center;z-index:9999;box-shadow:0 8px 30px rgba(0,0,0,.25)}\n#cookie-banner *{box-sizing:border-box}\n#cookie-banner .msg{flex:1;font-size:.88rem;line-height:1.4;max-width:100%;overflow-wrap:anywhere}\n#cookie-banner .actions{display:flex;gap:10px;flex-wrap:wrap}\n#cookie-banner button{cursor:pointer;border-radius:10px;padding:10px 14px;font-weight:600;border:1px solid #334155}#cookie-accept{background:#16a34a;color:#fff;border:none}#cookie-deny{background:#0b1220;color:#e2e8f0}#cookie-close{background:transparent;border:none;color:#94a3b8;font-size:1.2rem;padding:0;width:28px;height:28px;display:flex;align-items:center;justify-content:center;cursor:pointer}\n@media (max-width:560px){#cookie-banner{left:16px;right:16px;flex-direction:column;align-items:flex-start}#cookie-banner .msg{width:100%;font-size:.82rem}}';
